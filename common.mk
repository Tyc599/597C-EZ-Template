...
$(call test_output_2,Adding timestamp ,printf '%s\n' '.section .rodata' '.align 4' '.global _PROS_COMPILE_TIMESTAMP_INT' '_PROS_COMPILE_TIMESTAMP_INT:' '.word 0' '.global _PROS_COMPILE_TIMESTAMP' '_PROS_COMPILE_TIMESTAMP:' '.asciz ""' '.global _PROS_COMPILE_DIRECTORY' '_PROS_COMPILE_DIRECTORY:' '.asciz ""' | $(ARCHTUPLE)as -o $(LDTIMEOBJ) -,$(OK_STRING))
endef
